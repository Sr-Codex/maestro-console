...
> Doc-âncora de "o que existe HOJE". Atualizado: **2026-07-02 · v0.49.0**.
...
### Orquestração de equipe — Fases A+B (v0.47.0/v0.48.0/v0.49.0), ver [`docs/14-plano-orquestracao-equipe.md`](14-plano-orquestracao-equipe.md)

...
> Mapa de TODOS os docs, com o estado de cada um. **Atualizado: 2026-07-01 (v0.47.0).**
...
| Doc | O que é |
|---|---|
| [`../CHANGELOG.md`](../CHANGELOG.md) | Histórico real de versões (v0.1.0→v0.47.0). |
...
| [`14-plano-orquestracao-equipe.md`](14-plano-orquestracao-equipe.md) | **Plano cirúrgico:** orquestração de equipe — **Fase A entregue (v0.47.0)**: Team Templates + materializador reusando o Grupo do canvas. Fase B (NL) e editor visual em aberto. |

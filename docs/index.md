...
| [`18-plano-estado-por-no.md`](18-plano-estado-por-no.md) | **Plano cirúrgico:** sistema de estado por nó / "precisa de você" (#1 da pesquisa) — ~85% já existe; plano fecha o último quilômetro. Aguarda validação do usuário. |

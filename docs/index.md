...
> Mapa de TODOS os docs, com o estado de cada um. **Atualizado: 2026-07-02 (v0.49.0).**
...
| [`14-plano-orquestracao-equipe.md`](14-plano-orquestracao-equipe.md) | **Plano cirúrgico:** orquestração de equipe — **Fases A+B entregues** (v0.47.0/v0.48.0): Team Templates + materializador (FAB) e `maestri team` por linguagem natural (confirmação humana obrigatória). "Montar equipe" agora segue clique-pra-posicionar (v0.49.0, §13). **Fase C** (editor visual) e **Fase D** (líder de grupo/delegate mode) planejadas, ainda não implementadas. |

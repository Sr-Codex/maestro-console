...
> Mapa de TODOS os docs, com o estado de cada um. **Atualizado: 2026-07-01 (v0.49.0).**
...
| Doc | O que é |
|---|---|
| [`../CHANGELOG.md`](../CHANGELOG.md) | Histórico real de versões (v0.1.0→v0.49.0). |
...
| [`14-plano-orquestracao-equipe.md`](14-plano-orquestracao-equipe.md) | **Plano cirúrgico:** orquestração de equipe — **Fases A+B+C entregues** (v0.47.0/v0.48.0/v0.49.0): Team Templates + materializador (FAB), `maestri team` por linguagem natural (confirmação humana obrigatória) e editor visual de templates. **Fase D** (líder de grupo/delegate mode) planejada, ainda não implementada. |

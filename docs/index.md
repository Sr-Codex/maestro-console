...
| [`28-plano-capsula-grupo.md`](28-plano-capsula-grupo.md) | Plano da cápsula contextual de GRUPO (v0.63.0, ADR — seleção cairo + apagar confirmado; hierarquia de cápsulas). |
| [`29-plano-budget-pausa-retomada.md`](29-plano-budget-pausa-retomada.md) | Plano do budget cap com pausa graciosa + retomada 1-clique (v0.64.0, ADR-26; v2 pós-Fable — FIFO de dispatches REPROVADA). |
| [`30-plano-briefing-grupo.md`](30-plano-briefing-grupo.md) | Plano do briefing persistente por grupo (v0.65.0, ADR-27; bloco marcado em CLAUDE.md/AGENTS.md do workspace, host-only). |
| [`31-plano-contas-por-no.md`](31-plano-contas-por-no.md) | Plano das CONTAS por nó — config-dir isolado `CLAUDE_CONFIG_DIR`/`CODEX_HOME` (v0.66.0, ADR-28; 12 emendas Fable; prova de isolamento no device). |
| [`32-plano-paste-imagem.md`](32-plano-paste-imagem.md) | Plano do paste/drag de imagem e arquivo pro nó (v0.67.0, ADR-29; 9 emendas Fable com medições no device; regra E1 de nome hostil). |
